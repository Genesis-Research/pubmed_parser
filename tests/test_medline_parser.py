...
def test_parse_medline_xml():
    ...
    assert parsed_medline[2]["mesh_headings"] == "D000818:Animals;D000906:Antibodies;D004283:Dog Diseases;" \
    ...
    assert parsed_medline[2]["mesh_terms"] == "D000818:Animals;D000906/Q000032:Antibodies/analysis*;" \
